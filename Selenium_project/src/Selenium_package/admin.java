...
public class admin {
	...
	public static void main(String[] args) {
		...
		// 3. Open the web page https://www.linkedin.com/
			...
			// 5. In next line we are using getCurrentUrl method .This will give the current url of the webpage
		       ...
		       // 6. Using the navigate method we move to next webite http://www.youtube.com/
		        browserObject.navigate().to("http://www.youtube.com/");
